...
function changePowerTotal(totalPower, generatorID, generatorStatus, amountOfPower){
  if(generatorStatus == "on"){
    totalPower += amountOfPower;
    alert("Generator #" + generatorID + " is now " + generatorStatus + ", adding " + amountOfPower + " MW, for a total of " + totalPower + " MW!");
  }else if (generatorStatus == "off"){
    totalPower-= amountOfPower;
    alert("Generator #" + generatorID + " is now " + generatorStatus + ", removing " + amountOfPower + " MW, for a total of " + totalPower + " MW!");
  }
  return totalPower;
}