<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductDetailsRep.aspx.cs" Inherits="WebSample.SiteAdministration.ProductDetailsRep" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <strong>Viewing Product Details: (via repository)</strong>
    <br />
    <asp:FormView ID="frmProductDetails" runat="server" RenderOuterTable="true"
        ...
        <ItemTemplate>
            ...
            &nbsp;<asp:DropDownList ID="cmbInsertProductCategory" runat="server"
                ...
                DataTextField="Name" DataValueField="CategoryID" OnInit="cmbInsertProductCategory_Init">
            </asp:DropDownList>
            <br />
            <br />
            <strong>Description:</strong>
        ...
        <EditItemTemplate>
            ...
            &nbsp;<asp:DropDownList ID="cmbEditCategories" runat="server"
                ...
                SelectedValue='<%# BindItem.CategoryID %>' 
                SelectMethod="GetCategories" 
                DataTextField="Name" DataValueField="CategoryID" OnInit="cmbEditCategories_Init">
		    </asp:DropDownList>
            <br />
            <br />
            <strong>Description:</strong>
