<%@ Control Language="C#" CodeBehind="Integer_Edit.ascx.cs" Inherits="WingTipToysDynD.Integer_EditField" %>

<asp:TextBox ID="TextBox1" runat="server" Text="<%# FieldValueEditString %>" TextMode="Number" Columns="10" CssClass="DDTextBox"></asp:TextBox>
